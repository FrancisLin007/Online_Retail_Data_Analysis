...
There are 2,955 unique products were sold in last month and the total revenue for last month is 1,509,496 pound sterling. The pie chart shows the top 15 products with the highest revenue in last month. The total revenue of those 15 products is 241,248.1 pound sterling which shares about 15.98% of the total revenue for last month.  
...
According to the plot, we can see average sale price for the month of 2011-01-01 is quite large. This happened may because some customers purchase a huge amount of certain products at that month. The average sale price for the month of 2011-12-01 is even larger. However this result may not accurate since we only have the data of first 9 days for that month.
